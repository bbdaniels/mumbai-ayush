...
tostring dr_5b_no re_1_a re_12_a_1 re_12_a_2 med_h_1 med_j_2  cp_13 med_f_2 med_f_3 re_*_c re_2_c re_10_b re_11_a re_12_a_4 re_12_*_* cp_12 cp_12_3 med_h_1 med_j_2 re_4_a, force replace
...
use "${directory}/data/sp-private-0.dta"
  tostring form , replace

qui append using ///
  "${directory}/data/sp-private-1.dta" ///
  "${directory}/data/sp-private-2.dta" , gen(wave) force
